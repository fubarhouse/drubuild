...
func (VirtualHost *VirtualHost) Uninstall() {
	_, statErr := os.Stat(VirtualHost.installationDirectory + "/" + VirtualHost.GetUri() + ".conf")
	if statErr == nil {
